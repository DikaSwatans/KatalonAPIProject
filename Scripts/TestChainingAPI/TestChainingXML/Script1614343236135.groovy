...
response1 = WS.sendRequest(findTestObject('APIChainingXML/CountryInfoService/LustCountries'))
...
WS.sendRequestAndVerify(findTestObject('APIChainingXML/CountryInfoService/GetCapitalCity'))
